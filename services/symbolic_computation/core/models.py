...
__dora_meta__ = {
    ...
    "integrates_with": {
        ...
        "memory_layers": [],
        "imported_by": ["services.symbolic_computation.api.routes", "services.symbolic_computation.core.__init__", "services.symbolic_computation.core.code_generator", "services.symbolic_computation.core.expression_evaluator", "services.symbolic_computation.core.metrics", "services.symbolic_computation.core.validator"],
    },
}
# ============================================================================
...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["caching", "data-models", "enum", "messaging", "metrics", "operations", "pydantic", "security", "validation"],
    "keywords": ["backend", "computation", "gen", "health", "language", "metrics", "models", "status"],
