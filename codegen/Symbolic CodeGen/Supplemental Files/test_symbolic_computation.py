...
__dora_meta__ = {
    ...
    "created_at": "2026-01-01T13:15:24Z",
    "updated_at": "2026-01-15T15:48:34Z",
    "layer": "operations",
    "domain": "current_work",
    "module_name": "test_symbolic_computation",
    "type": "test",
    "status": "active",
    "integrates_with": {
        "api_endpoints": [],
...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["async", "caching", "current-work", "messaging", "metrics", "operations", "test", "testing", "validation"],
