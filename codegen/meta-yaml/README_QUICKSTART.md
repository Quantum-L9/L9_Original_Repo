...
Copy the 4 meta templates to `/codegen/templates/meta/`:
```bash
cp meta.codegen.schema.yaml /codegen/templates/meta/
cp meta.extraction.sequence.yaml /codegen/templates/meta/
cp meta.validation.checklist.yaml /codegen/templates/meta/
cp meta.dependency.integration.yaml /codegen/templates/meta/
```
