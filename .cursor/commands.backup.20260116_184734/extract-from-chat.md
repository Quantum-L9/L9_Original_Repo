...
version: "7.0.0"
component_id: "CMD-EXTRACTMEMORY-001"
component_name: "Extract From Chat - Synthetic Memory"
layer: "commands"
domain: "memory"
type: "slash_command"
status: "active"
...
# === COMMAND METADATA ===
name: extract-memory
description: "L9-native memory extraction — pull insights, files, decisions from chat transcripts"
auto_chain: ynp
---

# === L9 EXTRACT-MEMORY: Synthetic Memory Extraction ===
# Cursor Slash Command: /extract-memory
...
### Simple Extraction
```
/extract-memory @chat_history.md
...
### Multiple Chats
```
/extract-memory @chat1.md @chat2.md @chat3.md
...
```
/extract-memory @dense_chat.md --exhaustive
...
### Files Only
```
/extract-memory @chat.md --files-only
...
### Insights Only
```
/extract-memory @chat.md --insights-only
...
### Specific Categories
```
/extract-memory @chat.md --categories strategic,learning
...
```
/extract-memory @"Chat - VPS Deploy L9.md"
...
```
/extract-memory @"Brainstorm.md" --insights-only
