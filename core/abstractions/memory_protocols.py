...
__dora_meta__ = {
    ...
    "created_by": "L9 Refactoring Initiative",
...
# Import schemas if they exist, otherwise use Any
try:
    from core.schemas import PacketEnvelopeIn, PacketWriteResult
except ImportError:
    PacketEnvelopeIn = Any  # type: ignore
    PacketWriteResult = Any  # type: ignore
...
# ============================================================================
# tags: ["abstractions", "dependency-injection", "dip", "protocols"]
