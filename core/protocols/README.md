...
- **`WorldModelService`** — World model service. Implementations: WorldModelEngine, etc.

### Exported Symbols (`__all__`)

`ActivatableAgent`, `AgentContext`, `AgentOrchestrator`, `AgentRegistry`, `AgentState`, `BackoffStrategy`, `CacheClient`, `CacheService`, `ConnectionPoolProtocol`, `ConnectionProtocol`
...
- **File:** `error_handling_protocols.py:466`
- **Async:** Yes
