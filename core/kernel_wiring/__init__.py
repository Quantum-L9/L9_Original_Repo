...
# ============================================================================
__dora_footer__ = {
    "component_id": "COR-FOUN-131",
    "governance_level": "critical",
    "compliance_required": True,
    "audit_trail": True,
    "dependencies": [],
    "tags": ["core", "event-driven", "foundation", "profiling", "testing", "utility"],
    "keywords": ["kernel", "module"],
    "business_value": "Provides accessor functions for each of the 10 consolidated kernels. Imports are lazy to avoid circular dependency issues during testing.",
