...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["agent-execution", "api", "debugging", "foundation", "logging", "metrics", "monitoring", "tracker"],
    "keywords": ["bootstrap", "bound", "counter", "gauge", "histogram", "kernels", "labels", "metrics"],
