...
__dora_meta__ = {
    ...
    "integrates_with": {
        ...
        "datasources": [],
        "memory_layers": [],
        "imported_by": ["core.schemas.__init__", "orchestration.ws_task_router", "orchestrators.ws_bridge", "tests.orchestrators.test_ws_task_router_routing", "tests.runtime.test_packet_envelopes_invariants"],
    },
}
# ============================================================================
...
# ============================================================================
__dora_footer__ = {
    "component_id": "COR-FOUN-068",
    "governance_level": "critical",
    "compliance_required": True,
    "audit_trail": True,
    "dependencies": [],
    "tags": ["api", "batch-processing", "data-models", "enum", "event-driven", "foundation", "messaging", "pydantic", "queue", "realtime"],
    "keywords": ["agent", "all", "any", "assign", "batch", "completed", "core", "envelope"],
    "business_value": "Provides tasks components including TaskStatus, TaskKind, AgentTask",
