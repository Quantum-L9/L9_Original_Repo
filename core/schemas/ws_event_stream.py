...
__dora_meta__ = {
    ...
    "integrates_with": {
        ...
        "datasources": [],
        "memory_layers": [],
        "imported_by": ["core.schemas.__init__", "orchestration.unified_controller", "orchestration.ws_task_router", "orchestrators.ws_bridge", "runtime.websocket_orchestrator", "tests.integration.test_ws_task_routing_integration", "tests.orchestrators.test_ws_task_router_routing", "tests.runtime.test_websocket_orchestrator_basic", "tests.runtime.test_ws_protocol_static"],
    },
}
# ============================================================================
...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["api", "data-models", "enum", "event-driven", "foundation", "messaging", "monitoring", "pydantic", "realtime", "streaming"],
    "keywords": ["agent", "event", "heartbeat", "specific", "stream", "structure", "types", "websocket"],
