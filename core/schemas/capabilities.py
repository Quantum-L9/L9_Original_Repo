...
__dora_meta__ = {
    ...
    "integrates_with": {
        ...
        "datasources": [],
        "memory_layers": [],
        "imported_by": ["ci.check_tool_wiring", "core.agents.kernel_registry", "core.governance.approval_gate", "core.schemas.__init__", "core.schemas.event_stream", "orchestration.task_router"],
    },
}
# ============================================================================
...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["api", "authorization", "data-models", "enum", "foundation", "profiling", "pydantic", "rest-api", "validation"],
    "keywords": ["agent", "allowed", "approval", "capabilities", "capability", "denied", "handshake", "igor"],
