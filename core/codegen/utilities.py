...
class CodeValidator:
    ...
    async def validate_all(
        ...
        passed = all(g.passed for g in gate_results if "MANDATORY" in g.name) and overall_score >= 85
    ...
    async def _gate_1_syntax(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
    ...
    async def _gate_2_type_safety(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
    ...
    async def _gate_3_imports(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
    ...
    async def _gate_4_l9_patterns(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
        ...
        for file_path in files:
            if file_path.suffix == ".py":
                ...
                if "def " in content and "async def" not in content and file_path.name != "__init__.py":
    ...
    async def _gate_5_feature_flags(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
        """Gate 5: Feature flag awareness"""
        return ValidationGate(
            gate_id=5,
            name="Feature Flag Awareness",
            passed=True,
            score=100.0
        )
    
    async def _gate_6_kernel_deps(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
    ...
    async def _gate_7_memory_substrate(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
    ...
    async def _gate_8_tool_registry(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
        """Gate 8: Tool registry bindings"""
        return ValidationGate(
            gate_id=8,
            name="Tool Registry Bindings",
            passed=True,
            score=100.0
        )
    
    async def _gate_9_packet_contract(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
    ...
    async def _gate_10_error_handling(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
    ...
    async def _gate_11_async_patterns(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
    ...
    async def _gate_12_test_coverage(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
    ...
    async def _gate_13_security(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
    ...
    async def _gate_14_performance(self, files: list[Path], spec: dict[str, Any]) -> ValidationGate:
