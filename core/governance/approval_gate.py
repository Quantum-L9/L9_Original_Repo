...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": ["core.governance.approval_manager", "core.schemas", "core.schemas.capabilities"],
    "tags": ["async", "dataclass", "foundation", "governance", "logging", "messaging", "realtime", "security", "tracing"],
    "keywords": ["approval", "cursor", "decision", "escalate", "escalation", "gate", "governance", "handle"],
