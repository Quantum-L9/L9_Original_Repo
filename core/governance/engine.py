...
__dora_meta__ = {
    ...
    "integrates_with": {
        ...
        "imported_by": ["api.server", "core.tools.registry_adapter", "scripts.workspace.init_workspace", "tests.core.governance.test_engine"],
    },
}
# ============================================================================
...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": ["core.decorators", "core.governance.loader", "core.governance.schemas", "core.schemas"],
    "tags": ["api", "async", "config", "debugging", "engine", "foundation", "governance", "logging", "service", "tracing"],
    "keywords": ["action", "allowed", "count", "create", "default", "deny", "effect", "engine"],
