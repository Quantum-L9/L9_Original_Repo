...
# ============================================================================
__dora_meta__ = {
    "component_name": "AI Operating System Runtime",
...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": ["core.aios.runtime"],
    ...
    "business_value": "Provides the AIOS runtime that handles agent reasoning and tool calling. runtime: AIOSRuntime class for LLM-based reasoning schemas: Shared types (imported from core.agents.schemas) Version: 1.0.0",
