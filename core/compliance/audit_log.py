...
__dora_meta__ = {
    ...
    "integrates_with": {
        ...
        "imported_by": ["api.routes.commands", "core.compliance.__init__", "memory.slack_ingest", "tests.integration.test_compliance_audit", "tests.integration.test_igor_commands"],
    },
}
# ============================================================================
...
__dora_footer__ = {
    ...
    "tags": ["async", "audit-tool", "core", "debugging", "foundation", "logging", "messaging", "service"],
    "keywords": ["approval", "audit", "command", "compliance", "execution", "igor", "log", "logger"],
