...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["adapter", "async", "caching", "foundation", "logging", "messaging", "metrics", "tool-registry"],
    "keywords": ["check", "codegen", "computation", "compute", "engine", "generate", "health", "optimize"],
