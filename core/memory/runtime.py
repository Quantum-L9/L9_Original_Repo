...
__dora_footer__ = {
    ...
    "tags": ["api", "async", "audit-tool", "debugging", "event-driven", "foundation", "logging", "memory-substrate", "messaging", "security"],
    "keywords": ["audit", "event", "evolution", "history", "kernel", "log", "logging", "memory"],
