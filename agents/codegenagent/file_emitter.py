...
class FileChange:
    ...
    def __init__(
        ...
        """
        Initializes a FileChange instance to track a specific file modification in code generation workflows.
        Args:
            path: The file path affected by the change.
            action: The type of change ('create', 'modify', 'delete').
            old_content: Optional previous content of the file for rollback.
            new_content: Optional new content to be written to the file.
        """
        self.path = path
        self.action = action
    ...
    def __repr__(self) -> str:
        """Returns a string representation of the FileChange instance, including its action and file path."""
...
class EmissionResult:
    ...
    def __init__(self):
        """Initializes the EmissionResult object to track file emission outcomes, including created, modified, skipped files, errors, and changes."""
    ...
    def success(self) -> bool:
        """Returns True if the file emission process completed without errors; otherwise, False."""
        return len(self.errors) == 0

    @property
    def file_count(self) -> int:
        """Returns a summary dictionary of the file emission results, including counts of success, created, modified, skipped files, and errors."""
        """
        Calculates the total number of files affected in the code generation process.

        Args:
            None

        Returns:
            int: Total count of created and modified files in the emission result.
        """
...
class FileEmitter:
    ...
    def emit_from_ir(
        self, ir: ModuleIR, generated_files: dict[str, str]
    ) -> EmissionResult:
        """
    ...
    def _wire_server(
        ...
        import_line = (
            f"from api.routes.{module_name} import router as {module_name}_router"
        )
