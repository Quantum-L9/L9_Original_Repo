...
__dora_meta__ = {
    ...
    "integrates_with": {
        ...
        "imported_by": ["agents.__init__", "conftest", "core.agents.kernel_registry", "tests.agents.test_l_cto_memory_emission", "tests.config.test_l_cto_yaml", "tests.test_l_cto_kernel_activation", "tests.unit.conftest", "tests.unit.test_lcto_bootstrap"],
    },
}
# ============================================================================
...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": ["agents.base_agent", "core.schemas", "memory.substrate_service", "runtime.execution_gate", "runtime.introspection"],
    "tags": ["agent", "agent-execution", "api", "async", "authorization", "config", "debugging", "filesystem", "intelligence", "logging"],
    "keywords": ["absorb", "agent", "apply", "boot", "create", "cto", "describe", "end"],
