...
This super prompt enables Perplexity research agents to generate frontier-grade evolution 
of the L9 Cursor Promoting System, advancing autonomy from L2 (constrained) to L5 
(fully autonomous) while maintaining world-class traceability, safety, and governance.
