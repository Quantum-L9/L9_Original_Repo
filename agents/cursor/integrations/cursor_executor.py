...
class CursorTaskSpec(BaseModel):
    ...
    initial_state: Optional[CursorAgentState] = Field(None, description="Initial state (optional)")
...
class CursorExecutor:
    ...
    def __init__(
        ...
        dag_orchestrator: SubstrateDagOrchestrator,
        ...
        Args:
            ...
            dag_orchestrator: SubstrateDagOrchestrator instance
