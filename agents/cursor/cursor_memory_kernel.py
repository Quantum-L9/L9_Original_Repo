...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["agent-execution", "authorization", "cache", "config", "dataclass", "event-driven", "filesystem", "intelligence", "logging", "security"],
    "keywords": ["activate", "activation", "active", "agent", "behavior", "complete", "confidence", "count"],
