...
__dora_meta__ = {
    ...
    "integrates_with": {
        ...
        "imported_by": ["agents.__init__", "api.server", "core.tools.research_tools"],
    },
}
# ============================================================================
...
__dora_footer__ = {
    ...
    "tags": ["agent-execution", "api", "async", "cli", "client", "config", "dataclass", "engine", "event-driven", "filesystem"],
    "keywords": ["agent", "architectural", "build", "client", "compute", "concepts", "consensus", "create"],
    "business_value": "Provides research agent components including PromptVariation, ResearchResponse, SynthesisResult",
