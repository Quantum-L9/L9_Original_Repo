...
__dora_footer__ = {
    ...
    "tags": ["async", "audit-tool", "event-driven", "filesystem", "integration", "logging", "mcp-integration", "messaging", "monitoring", "serialization"],
    "keywords": ["audit", "breaker", "circuit", "fail", "fallback", "governance", "logger", "logging"],
