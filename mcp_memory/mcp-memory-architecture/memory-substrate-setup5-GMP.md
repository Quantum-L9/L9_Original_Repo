...
3. **TEST EXECUTION (DECLARATIVE)**
   - Declare which test suites _must_ be run by a human or CI (e.g., `pytest tests/api/testserverhealth.py`, `pytest tests/integration/testapimemoryintegration.py`).[3][2]
