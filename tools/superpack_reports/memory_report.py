...
__dora_footer__ = {
    ...
    "keywords": ["generate", "integration", "map", "memory", "report", "superpack"],
    "business_value": "Utility module for memory report",
