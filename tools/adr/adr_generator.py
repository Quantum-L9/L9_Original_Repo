...
# ============================================================================
__dora_meta__ = {
    "component_name": "Generates new ADR files from template",
...
# ============================================================================
__dora_footer__ = {
    "component_id": "TOO-OPER-011",
    "governance_level": "medium",
    "compliance_required": True,
    "audit_trail": True,
    "dependencies": [],
    "tags": ["api", "auth", "factory", "filesystem", "operations", "tools"],
    "keywords": ["adr", "files", "generate", "generates", "slugify", "template"],
    "business_value": "Utility module for adr generator",
