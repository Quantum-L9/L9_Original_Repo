...
**Tier 2: Ask for Features** 4. "Are placeholders acceptable or prohibited?" 5. "What data do we have access to?" 6. "Who/what will consume this output?"

**Tier 3: Ask for Complex Systems** 7. "What are the performance requirements?" 8. "Should this have confidence scores? How calculated?" 9. "What's the error handling strategy?" 10. "What's the rollback plan if this fails?"
