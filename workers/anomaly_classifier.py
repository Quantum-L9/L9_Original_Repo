...
__dora_footer__ = {
    ...
    "tags": ["api", "async", "auth", "data-models", "dataclass", "logging", "messaging", "metrics", "monitoring", "operations"],
    "keywords": ["anomaly", "check", "classification", "classifier", "create", "governance", "health", "pattern"],
