...
__dora_footer__ = {
    ...
    "tags": ["api", "async", "audit-tool", "data-models", "filesystem", "logging", "messaging", "operations", "pydantic", "schema"],
    "keywords": ["all", "audit", "check", "count", "counts", "create", "design", "detection"],
