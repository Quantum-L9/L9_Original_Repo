...
improvement_cache = ((avg_uncached - avg_cached) / avg_uncached * 100) if avg_uncached > 0 else 0
...
improvement_vector = ((avg_unoptimized - avg_optimized) / avg_unoptimized * 100) if avg_unoptimized > 0 else 0
...
improvement_combined = ((time_before - time_after) / time_before * 100) if time_before > 0 else 0
