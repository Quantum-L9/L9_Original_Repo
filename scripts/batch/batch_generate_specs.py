...
__dora_meta__ = {
    ...
    "layer": "operations",
    "domain": "scripts",
    "module_name": "batch_generate_specs",
    "type": "dataclass",
    "status": "active",
    "integrates_with": {
        "api_endpoints": [],
        "datasources": ["HTTP API", "Perplexity API", "Redis"],
        "memory_layers": [],
        "imported_by": [],
    },
}
...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["api", "async", "auth", "batch-processing", "cli", "client", "dataclass", "filesystem", "http-client", "logging"],
    "keywords": ["acquire", "batch", "bucket", "client", "generate", "generator", "limiter", "modules"],
    "business_value": "Provides batch generate specs components including BatchConfig, TokenBucketLimiter, PerplexityBatchClient",
