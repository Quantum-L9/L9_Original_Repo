...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["authorization", "caching", "cli", "dataclass", "debugging", "filesystem", "logging", "operations", "scripts", "security"],
    "keywords": ["analysis", "analyze", "directory", "ensure", "find", "fix", "insertion", "instantiated"],
