...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["api", "caching", "cli", "dataclass", "filesystem", "metrics", "operations", "scripts", "serialization", "testing"],
    "keywords": ["alignment", "canonical", "extract", "files", "green", "json", "paths", "print"],
