...
__dora_footer__ = {
    ...
    "tags": ["ast", "async", "builder-pattern", "caching", "cli", "dataclass", "endpoint", "filesystem", "logging", "operations"],
    "keywords": ["analyze", "audit", "builder", "cache", "check", "circular", "compute", "detect"],
