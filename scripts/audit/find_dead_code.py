...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["api", "ast", "caching", "cli", "dataclass", "debugging", "endpoint", "event-driven", "filesystem", "logging"],
    "keywords": ["agents", "analysis", "analyze", "app", "audit", "background", "baseline", "confidence"],
