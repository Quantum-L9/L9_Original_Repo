...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["auth", "cli", "config", "dataclass", "filesystem", "messaging", "operations", "scripts", "security", "serialization"],
    "keywords": ["all", "checklist", "coverage", "declaration", "final", "gmp", "hash", "integrity"],
