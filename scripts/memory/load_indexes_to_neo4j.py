...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["api", "auth", "cli", "debugging", "filesystem", "graph-db", "loader", "logging", "memory-substrate", "metrics"],
    "keywords": ["all", "catalog", "clear", "close", "connect", "create", "definitions", "function"],
