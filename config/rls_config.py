...
__dora_meta__ = {
    ...
    "integrates_with": {
        ...
        "memory_layers": [],
        "imported_by": ["api.routes.mcp", "core.agents.bootstrap.phase_7_verify_and_lock", "core.integration.graph_to_wm_sync", "core.integration.tool_pattern_extractor", "memory.governance_gate", "world_model.runtime"],
    },
}
# ============================================================================
...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["caching", "configuration", "foundation", "logging", "rest-api", "schema", "testing", "validation"],
    "keywords": ["deterministic", "generate", "org", "rls", "same", "tenant", "user", "uuid"],
