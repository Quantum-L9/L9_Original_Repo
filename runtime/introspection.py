...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["api", "audit-tool", "auth", "debugging", "logging", "messaging", "mocking", "operations", "runtime-operations", "utility"],
    "keywords": ["agent", "audit", "calibration", "confidence", "decision", "end", "execution", "export"],
