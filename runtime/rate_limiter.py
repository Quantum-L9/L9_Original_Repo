...
__dora_meta__ = {
    ...
    "integrates_with": {
        ...
        "memory_layers": [],
        "imported_by": ["api.server", "runtime.__init__"],
    },
}
# ============================================================================
...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": ["memory.graph_client", "runtime.redis_client"],
    "tags": ["api", "async", "cache", "debugging", "event-driven", "logging", "monitoring", "operations", "runtime-operations", "service"],
    "keywords": ["check", "increment", "limiter", "memory", "rate", "remaining", "reset", "usage"],
    "business_value": "Provides sliding window rate limiting for API calls, tool usage, etc. Version: 1.0.0",
