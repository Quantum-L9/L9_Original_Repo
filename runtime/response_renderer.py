...
# ============================================================================
__dora_meta__ = {
    "component_name": "Structured response generation with 5-section template.",
...
# ============================================================================
__dora_footer__ = {
    "component_id": "RUN-OPER-002",
    "governance_level": "medium",
    "compliance_required": True,
    "audit_trail": True,
    "dependencies": [],
    "tags": ["api", "builder-pattern", "logging", "operations", "runtime-operations", "utility"],
    "keywords": ["build", "builder", "citation", "claim", "claims", "confidence", "escalation", "format"],
    "business_value": "This module implements GODMODE Part 6 (Output Rendering).",
