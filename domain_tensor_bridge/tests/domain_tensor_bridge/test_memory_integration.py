...
def memory_bridge():
    ...
    substrate.query_events = AsyncMock(return_value=[
        {"id": "e1", "timestamp": "2026-01-02", "type": "test", "payload": {}, "metadata": {}}
    ])
    substrate.cypher_query = AsyncMock(return_value=[
        {"id": "n1", "type": "entity", "properties": {}, "edges": []}
    ])
