...
class ReasoningEngine:
    ...
    async def apply_analogical_reasoning(self, context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def _apply_symbolic(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if self.symbolic_reasoner:
            return self.symbolic_reasoner.apply_domain_rules(context, context.get("domain", "default"))
    ...
    async def _apply_reflective(self, mode_outputs: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    def _synthesize_decision(self, mode_outputs: List[Dict[str, Any]]) -> Dict[str, Any]:
