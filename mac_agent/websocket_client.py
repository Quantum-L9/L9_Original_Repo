...
__dora_footer__ = {
    ...
    "tags": ["api", "async", "client", "dataclass", "debugging", "event-driven", "executor", "integration", "logging", "mac-integration"],
    "keywords": ["agent", "agenthandshake", "client", "connect", "connected", "count", "create", "disconnect"],
