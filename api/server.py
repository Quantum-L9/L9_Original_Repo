...
try:
    from world_model.runtime import (RuntimeConfig,
...
try:
    ...
    from core.tools.agent_self_modify import create_self_modify_tool
    from services.research.graph_persistence import init_graph_persistence
...
async def lifespan(app: FastAPI):
    ...
    if L9_STAGE3_MODULES:
        ...
        if _has_event_queue:
            try:
                await init_event_driven_coordination(app.state)
