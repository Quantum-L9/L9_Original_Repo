...
# ============================================================================
__dora_meta__ = {
    "component_name": "Batch Query Helpers",
    ...
    "module_name": "substrate_repository_batch_helpers",
    "type": "service",
    "status": "active",
    "integrates_with": {
        "api_endpoints": [],
        ...
        "imported_by": [
            "memory.substrate_repository_batch_helpers",
            "tests.memory.test_batch_helpers",
        ],
    },
}
# ============================================================================
...
class BatchQueryHelpers:
    ...
    async def get_packets_with_metadata_batch(
        ...
        Example:
            ...
            ...     [uuid1, uuid2, uuid3], tenant_id="l-cto"
            ... )
    ...
    async def update_packets_status_batch(
        ...
        Example:
            ...
            ...     [uuid1, uuid2, uuid3], "completed", tenant_id="l-cto"
            ... )
    ...
    async def archive_packets_batch(
        ...
        async with self.repo.acquire() as conn:
            ...
            logger.info(
                f"Archived {archived_count} packets", packet_count=archived_count
            )
...
__dora_footer__ = {
    ...
    "business_value": "Implements BatchQueryHelpers for substrate repository batch helpers functionality",
