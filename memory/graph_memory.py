...
__dora_footer__ = {
    ...
    "tags": ["api", "async", "auth", "data-models", "dataclass", "debugging", "graph-db", "learning", "logging", "messaging"],
    "keywords": ["about", "chat", "conversation", "conversational", "cross", "entities", "extract", "extractor"],
