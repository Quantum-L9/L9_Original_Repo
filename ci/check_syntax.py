...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["ast", "async", "caching", "ci", "cli", "debugging", "filesystem", "logging", "messaging", "operations"],
    "keywords": ["broken", "check", "closing", "definition", "duplicate", "extra", "files", "find"],
    "business_value": "Implements SyntaxIssue for check syntax functionality",
