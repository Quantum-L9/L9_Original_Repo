...
__dora_footer__ = {
    ...
    "audit_trail": True,
    "dependencies": [],
    "tags": ["caching", "ci", "cli", "debugging", "filesystem", "http-client", "linting", "logging", "messaging", "operations"],
    "keywords": ["convert", "detect", "errors", "extract", "files", "find", "forbidden", "imports"],
