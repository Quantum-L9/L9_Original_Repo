...
- **File:** `harvest_deploy.py:103`
- **Async:** No

#### `def route_after_inject(state)`

Route after inject: validate if successful, report otherwise.

- **File:** `harvest_deploy.py:115`
- **Async:** No
