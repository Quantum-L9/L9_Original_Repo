...
async def memory_substrate_service():
    ...
    if not TEST_DB_URL:
        pytest.skip("TEST_DATABASE_URL or DATABASE_URL not set; skipping extraction pipeline tests.")
...
async def test_extraction_pipeline_creates_facts(memory_substrate_service: MemorySubstrateService):
    ...
    assert "status" in predicates or "version" in predicates or "description" in predicates, \
...
@pytest.mark.asyncio
async def test_extraction_pipeline_with_reasoning_block(memory_substrate_service: MemorySubstrateService):
    """
...
@pytest.mark.asyncio
async def test_extraction_pipeline_handles_empty_payload(memory_substrate_service: MemorySubstrateService):
    """
