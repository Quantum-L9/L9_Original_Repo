...
class TestWebSocketTracingMiddleware:
    ...
    async def test_middleware_extracts_trace_id_from_query_params(self):
        ...
        scope = {
            "type": "websocket",
            "path": "/ws",
            "query_string": f"trace_id={trace_id}".encode("utf-8"),
            "headers": [],
        }
        receive = AsyncMock()
        send = AsyncMock()
    ...
    async def test_middleware_prefers_query_params_over_headers(self):
        ...
        scope = {
            "type": "websocket",
            "path": "/ws",
            "query_string": f"trace_id={query_trace_id}".encode("utf-8"),
    ...
    def test_parse_query_string_multiple_params(self):
        ...
        result = middleware._parse_query_string("trace_id=123&correlation_id=456&foo=bar")
