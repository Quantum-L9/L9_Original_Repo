...
class TestL9ToThAdapter:
    ...
    async def test_multi_modal_reasoning_with_context(self, l9_adapter, test_context):
        ...
        results = await l9_adapter.multi_modal_reasoning_with_context(query, test_context)
    ...
    async def test_research_reasoning(self, l9_adapter, test_context):
        ...
        analysis = await l9_adapter.research_reasoning(hypothesis, evidence, test_context)
    ...
    async def test_agent_reasoning_history(self, l9_adapter, test_context):
        ...
        # Execute reasoning
        await l9_adapter.reason_with_context(query, ReasoningMode.ABDUCTIVE, test_context)
...
class TestPerformance:
    ...
    async def test_concurrent_reasoning(self):
        ...
        tasks = [
            engine.reason(query, ReasoningMode.ABDUCTIVE)
