...
_executor_composer: Optional["ExecutorComposer"] = None
...
async def get_executor_info():
    ...
    try:
        ...
        return {
            ...
            "di_services": list(_di_container._bindings.keys()) if _di_container else [],
        }
    except Exception as e:
...
async def list_di_services():
    ...
    services = {}
    for interface in _di_container._bindings.keys():
