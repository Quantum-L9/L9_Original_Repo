...
# ============================================================================
__dora_meta__ = {
    "component_name": "IR to Python Compiler",
    ...
    "integrates_with": {
        ...
        "imported_by": ["ir_engine.__init__"],
    },
}
# ============================================================================
...
TEMPLATES = {
    ...
    "module_base.py.j2": MODULE_TEMPLATE,
}
...
class IRToPythonCompiler:
    ...
    def _build_context(self, ir: ModuleIR) -> Dict[str, Any]:
        ...
        class_name = "".join(
            word.capitalize() for word in ir.module_id.replace("_", " ").split()
        )
    ...
    def _get_template_for_type(self, target_type: str) -> str:
        ...
        mapping = {
            ...
            "service": "module_base.py.j2",
            "worker": "module_base.py.j2",
        ...
        return mapping.get(target_type, "module_base.py.j2")
