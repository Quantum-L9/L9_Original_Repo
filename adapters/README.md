...
class AnomalyDetector:
    ...
    async def detect(self, ...) -> list[AnomalySignal]: ...

    def _check_confidence_collapse(self, ...) -> AnomalySignal | None: ...

    def _check_latency_breach(self, ...) -> AnomalySignal | None: ...

    def _check_statistical_outlier(self, ...) -> AnomalySignal | None: ...
...
class TensorGlobeBridgeAdapter:
    ...
    async def handle_tensor_request(self, ...) -> tuple[bool, TensorResponse | None, str | None]: ...

    def _validate_request_schema(self, ...) -> bool: ...

    async def _verify_request_signature(self, ...) -> bool: ...

    async def _call_tensorglobe(self, ...) -> TensorResponse: ...
...
`AnomalySignal`, `TensorGlobeBridgeAdapter`, `TensorOperation`, `TensorRequest`, `TensorRequestPacket`, `TensorResponse`, `TensorResponsePacket`, `TensorResult`, `tensorglobe_bridge`
